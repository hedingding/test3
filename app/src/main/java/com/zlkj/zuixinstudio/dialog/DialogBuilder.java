...
public class DialogBuilder {
	...
	public static DialogBuilder builder(Context context) {
		return new DialogBuilder(context).builder();
	}
	...
	public DialogBuilder setMessage(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public DialogBuilder setPositiveButton(String text, final OnClickListener listener) {
		showPosBtn = true;
		if ("".equals(text)) {
			btn_pos.setText("确定");
		} else {
	...
	public DialogBuilder setNegativeButton(String text, final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");
		} else {
